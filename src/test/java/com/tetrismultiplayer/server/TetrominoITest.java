...
import main.java.com.tetrismultiplayer.server.engine.terominos.TetrominoI;
...
public class TetrominoITest
{
    ...
    {
	tetromino = new TetrominoI(Color.BLUE, 100, 100);
    }
    ...
    {
	assertEquals("I", tetromino.getType().name());
    }
}