...
import main.java.com.tetrismultiplayer.server.engine.terominos.TetrominoO;
...
public class TetrominoOTest
{
    ...
    {
	tetromino = new TetrominoO(Color.BLUE, 100, 100);
    }
    ...
    {
	assertEquals(Color.blue, tetromino.getColor());
    }
    ...
    {
	assertEquals("O", tetromino.getType().name());
    }
