...
import main.java.com.tetrismultiplayer.server.engine.terominos.TetrominoT;
...
public class TetrominoTTest
{
    ...
    {
	tetromino = new TetrominoT(Color.BLUE, 100, 100);
    }
    ...
    {
	assertEquals("T", tetromino.getType().name());
    }
}