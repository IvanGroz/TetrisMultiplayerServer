...
import main.java.com.tetrismultiplayer.server.engine.terominos.TetrominoZ;
...
public class TetrominoZTest
{
    ...
    {
	tetromino = new TetrominoZ(Color.BLUE, 100, 100);
    }
	...
	assertEquals(101, all.get(3).getPosition().x);
	...
	assertEquals(100, all.get(2).getPosition().y);
	assertEquals(101, all.get(3).getPosition().y);
    }
    ...
    {
	assertEquals("Z", tetromino.getType().name());
    }
}